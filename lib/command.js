/**
 * Almost all of this was either adapted from / straight up jacked from the
 * great `commander.js` by TJ Holowaychuk. Do yourself a favor and check it out:
 *
...
Command.prototype.exec = Command.prototype.execute = function (fn) {
  this.parent.on(this.name, fn);
};
